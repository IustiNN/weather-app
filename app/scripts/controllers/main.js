...
.controller('MainCtrl', ['$scope', '$http', function ($scope, $http) {
  ...
  $scope.updateLocation = function() {
    if($scope.city !== '') {
      $http.jsonp( 'http://api.openweathermap.org/data/2.5/forecast/daily?APPID=8615380fe529fe5f66942fed8cd1c327&callback=angular.callbacks._0&q='+$scope.city+'&units=metric'
    ).success(function(response) {
